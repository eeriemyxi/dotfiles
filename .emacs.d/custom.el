(custom-set-variables
 ...
 '(package-selected-packages
   '(fish-mode xonsh-mode undo-tree treesit-auto titlecase shift-number shell-pop rainbow-delimiters pulsar mistty meow-tree-sitter markdown-mode magit lua-mode kotlin-mode hydra hl-todo gruvbox-theme goto-chg flx exec-path-from-shell dtrt-indent dirvish counsel company-prescient centaur-tabs avy aggressive-indent)))
(custom-set-faces
